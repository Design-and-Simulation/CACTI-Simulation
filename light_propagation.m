%LIGHT_PROPAGATION	Simulation of the imaging process of CACTI system
%   LIGHT_PROPAGATION demonstrates the imaging process of CACTI system containing 
%   a dmd and a  static mask step by step based on geometrical optics. The 
%   detailed simulation pipeline is shown in this script.
%   
%   Note: 
%   --------
